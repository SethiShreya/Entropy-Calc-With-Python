...
df= pd.read_csv("./Shannon/BinaryEquivalentOutput with windowsize=31961.csv")
...
makeHistogram(df, "Shannon Entropy Histogram", "Shannon Entropy", "Frequency", "Shannon_BinaryEquivalentOutput with windowsize=31961.csv")
